...
@section('content')
    @include('front.layouts.navbars.guest.navbar')
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}" enctype="multipart/form-data">
                                ...
                                </div><div class="flex flex-col mb-3">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="file" name="image" class="form-control" placeholder="Your Photo" aria-label="Photo" >
                                    @error('image') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3 {{$errors->has('g-recaptcha-response')? 'has-error' : ''}}">
                                    {!! NoCaptcha::display() !!}
    ...
    @include('front.layouts.footers.guest.footer')
@endsection
